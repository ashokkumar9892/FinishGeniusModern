...
public static class PageCatalog
{
    ...
    [
        ...
        new("colorMatching", "Color Matching", "Formulation", [P, GA, SA],
            [new("samples", "Sample Library"), new("match", "Match a Colour"), new("preview", "Stain Preview")]),
    ...
    [
        ...
        ("/api/color-matching", ["colorMatching"]),
